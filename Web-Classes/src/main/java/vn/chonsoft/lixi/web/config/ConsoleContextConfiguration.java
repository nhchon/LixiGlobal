...
@PropertySource(value = { "file:/home/chonnh/Projects/YuricProjects/LixiGlobal/Web/src/main/resources/lixi.properties"}, ignoreResourceNotFound = true)
@Import({ SecurityConfiguration.class })
public class ConsoleContextConfiguration  implements
