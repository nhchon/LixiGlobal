...
import vn.chonsoft.lixi.repositories.service.LixiAsyncService;
...
public class CheckOutController {
    ...
    @Inject
    private LixiAsyncService lxAsyncService;
     ...
     * @param order
     */
    private void processTopUpItems(LixiOrder order) {
     ...
     * @param order
     */
    private void processBuyCardItems(LixiOrder order) {
    ...
    public ModelAndView placeOrder(@RequestParam Integer setting, HttpServletRequest request) throws Exception {
        ...
        if (orderId != null) {
            ...
            processTopUpItems(order);
            
            // Buy Cards
            //processBuyCardItems(order);
            
            //////////////////////// SUBMIT ORDER to BAOKIM:  Asynchronously ////////////////////
            lxAsyncService.submitOrdersToBaoKim(order);
            ////////////////////////////////////////////////////////////////////
