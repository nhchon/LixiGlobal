...
jQuery(document).ready(function($) {
        ...
        var path = CONTEXT_PATH + '/resource/theme/';
	// switcher toggle 	
	...
	var skinLogoDefault = path + 'assets/img/kingadmin-logo-white.png';
	...
	$('.switch-skin, .switch-skin-full').click( function(e) {
		...
		if($(this).hasClass('fullbright')) {
			skinLogo = path + 'assets/img/kingadmin-logo.png';
		}else {
	...
	function resetStyle() {
		...
		$('.logo img').attr('src', path + 'assets/img/kingadmin-logo-white.png');
