                ...
                <div class="section-receiver">
                    ...
                    <form:form role="form" modelAttribute="userEditPasswordForm">
                        ...
                        <div class="form-group">
                            <div class="col-md-8">
                                <label for="currentPassword" class="control-label"><spring:message code="mess.current-pass"/></label>
                        ...
                        <div class="form-group">
                            <div class="col-md-8">
                                <label for="password" class="control-label"><spring:message code="mess.new-pass"/></label>
                        ...
                        <div class="form-group">
                            <div class="col-md-8" style="margin-bottom: 10px;">
                                <label for="confPassword" class="control-label"><spring:message code="mess.reenter-new-pass"/>:</label>
                        ...
                        <div class="form-group right">
                            <div class="col-md-8">
                                <button id="btnSubmit" class="btn btn-primary"><spring:message code="message.save_changes"/></button>
