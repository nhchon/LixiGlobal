        ...
        <section class="main-section bg-default">
            <div class="container post-wrapper" style="padding-top:30px;">
                <div class="section-receiver">
                    ...
                    <h2 class="title"><spring:message code="mess.change-email"/></h2>
                    <form:form  modelAttribute="userEditEmailForm"  role="form">
                        <div class="form-group">
                            <div class="col-md-8" style="margin-bottom: 10px;">
                                <label for="email" class="control-label"><spring:message code="mess.old-email-address"/></label>
                                <input type="text" class="form-control" readonly="" disabled="" value="${USER_LOGIN_EMAIL}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-8" style="margin-bottom: 10px;">
                                <label for="email" class="control-label"><spring:message code="mess.new-email-address"/></label>
                        ...
                        <div class="form-group">
                            <div class="col-md-8" style="margin-bottom: 10px;">
                                <label for="confEmail" class="control-label"><spring:message code="mess.reenter-new-email"/>:</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-8" style="margin-bottom: 10px;">
                                <label for="password" class="control-label"><spring:message code="mess.enter-your-pass"/></label>
                        ...
                        <div class="form-group">
                            <div class="col-md-8">
                                <button type="submit" class="btn btn-primary"><spring:message code="message.save_changes"/></button>
