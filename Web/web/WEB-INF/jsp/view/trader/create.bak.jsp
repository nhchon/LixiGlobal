    ...
    <body>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="menu">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation" class="active"><a href="<c:url value="/trader/create"/>">Trader Create</a></li>    
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="recent">
                        <button class="btn-primarys"><h3>Trader Registration</h3></button>
                    </div>
                    ...
                    <form:form method="post" role="form" modelAttribute="traderCreateForm">
                        ...
                        <button type="submit" class="btn btn-default"><spring:message code="message.create_account"/></button>
                    </form:form>
                </div>
            </div>
        </div>
