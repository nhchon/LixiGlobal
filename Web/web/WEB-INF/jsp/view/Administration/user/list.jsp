<template:Admin htmlTitle="Administration -:- Dashboard">
    ...
    <jsp:body>
        ...
        <!-- main -->
        <div class="row">
            <div class="col-md-6"><h3 class="sub-header"><i class="fa fa-table"></i><spring:message code="message.system.user.list"/></h3></div>
            <div class="col-md-6">
                <h3 class="pull-right"><a href="<c:url value="/Administration/SystemUser/add"/>">Add New User</a></h3>
            </div>
        </div>
