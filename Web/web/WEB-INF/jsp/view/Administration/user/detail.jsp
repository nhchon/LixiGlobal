        ...
        <div class="col-md-10 content-wrapper">
            ...
            <div class="content">
                <div class="main-header">
                    <h2><spring:message code="message.system.user.detail_page"/></h2>
                </div>

                <div class="main-content">
                    <div class="widget">
                        <div class="widget-header">
                            <h3><i class="fa fa-edit"></i> <spring:message code="message.system.user.detail_form"/></h3>
                        </div>
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h3><i class="fa fa-edit"></i> <spring:message code="message.roles"/></h3>
                        </div>
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-sm-6">
