        ...
        <div class="col-md-10 content-wrapper">
            ...
            <div class="content">
                <div class="main-header">
                    <h2>List of cities of BringFido</h2>
                                ...
                                <tbody>
                                    <c:forEach items="${cities.content}" var="city">
                                        <tr>
                                            ...
                                            <td><c:out value="${city.stateAbbr}" /></td>
                                            <td><c:out value="${city.cityName}" /></td>
                                            <td><c:out value="${city.cityUrl}" /></td>
                                            <td><c:out value="${city.completed}" /></td>
                                            <td><c:out value="${city.createdDate}" /></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="dataTables_paginate paging_simple_numbers" id="datatable-column-interactive_paginate">
                                        <ul class="pagination">
                                            <c:forEach begin="1" end="${cities.totalPages}" var="i">
                                                <c:choose>
                                                    <c:when test="${(i - 1) == cities.number}">
                                                    ...
                                                    <c:otherwise>
                                                        <li class="paginate_button" aria-controls="datatable-column-interactive" tabindex="0">
                                                            <a href="<c:url value="/Administration/Fido/cities">
