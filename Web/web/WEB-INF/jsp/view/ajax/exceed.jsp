{
    ...
    "RECIPIENT_TOTAL_INC_SHIPPING_USD": "<fmt:formatNumber value="${RECIPIENT_TOTAL_INC_SHIPPING_USD}" pattern="###,###.##"/>",
    "RECIPIENT_TOTAL_INC_SHIPPING_VND": "<fmt:formatNumber value="${RECIPIENT_TOTAL_INC_SHIPPING_USD}" pattern="###,###.##"/>",
