                            ...
                            <div class="menu">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <c:if test="${empty LOGIN_EMAIL}">
                                        <li role="presentation" class="active"><a href="<c:url value="/user/signUp"/>">Sign Up</a></li>						
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div><p>New to Lixi.global? Please register below</p></div>
                    ...
                    <form:form method="post" role="form" modelAttribute="userSignUpForm">
                        <div class="row form-group">
                            <div class="col-lg-4">
                                <form:input path="lastName" class="form-control" placeholder="Last Name"/>
                                <span class="help-block with-errors errors"><form:errors path="lastName" /></span>
                            </div>
                            <div class="col-lg-4">
                                <form:input class="form-control" path="firstName" placeholder="First Name"/>
                                <span class="help-block with-errors errors"><form:errors path="firstName" /></span>
                            </div>
                            <div class="col-lg-4">
                                <form:input class="form-control" path="middleName" placeholder="Middile Initials"/>
                                <span class="help-block with-errors errors"><form:errors path="middleName" /></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <form:input type="email" class="form-control" path="confEmail" placeholder="Retype Email"/>
                            <span class="help-block with-errors errors"><form:errors path="confEmail" /></span>
                        </div>
                        <div class="form-group">
                            <form:input type="text" class="form-control" path="phone" placeholder="Phone"/>
                        </div>
                        
                        <div><p>Protect your information with a password</p></div>
                        ...
                        <div class="form-group">
                            <form:input type="password" class="form-control" path="confPassword" placeholder="Retype Password"/>
